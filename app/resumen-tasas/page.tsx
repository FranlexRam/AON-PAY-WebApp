...
export default function ResumenTasasCliente() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel("realtime-resumen-cliente")
      .on(
        "postgres_changes",
    ...
    return (
      <main className="min-h-screen bg-[#121212] text-[#f4f1ea] flex items-center justify-center p-4">
        <div className="text-center space-y-3 animate-pulse">
          ...
          <p className="text-xs text-[#f4f1ea]/60 font-medium">Cargando resumen de tasas...</p>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-[#121212] text-[#f4f1ea] flex flex-col items-center p-4 py-8 antialiased selection:bg-[#b58e45] selection:text-[#121212]">
      <div className="w-full max-w-6xl space-y-6">
        ...
        <div className="bg-[#2c2e30] border border-[#b58e45]/20 rounded-2xl p-5 shadow-xl flex flex-col sm:flex-row justify-between items-center gap-4">
          <div>
            ...
            <h1 className="text-lg font-bold text-[#f4f1ea]">Resumen Organizado de Tasas del Día</h1>
            <p className="text-xs text-[#f4f1ea]/60">Consulta las tasas oficiales actualizadas para cada país</p>
          </div>

          <div className="bg-[#121212]/60 border border-[#b58e45]/30 px-4 py-2 rounded-xl text-center shrink-0">
            <p className="text-[10px] text-[#f4f1ea]/50 uppercase font-bold">Fecha Oficial</p>
            <p className="text-xs font-extrabold text-[#b58e45]">{getFormattedDate()}</p>
          </div>
        </div>

        {/* GRILLA DE PLACAS INFORMATIVAS */}
